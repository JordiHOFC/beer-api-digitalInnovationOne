...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Jordi H Silva";
    private static final String CONTACT_GITHUB = "https://gtihub.com/jordihofc";
    private static final String CONTACT_EMAIL = "jordih.silva@gmail.com";
